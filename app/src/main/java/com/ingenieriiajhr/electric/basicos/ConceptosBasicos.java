package com.ingenieriiajhr.electric.basicos;
...
import com.ingenieriiajhr.data.DataConceptosBasicos;
...
public class ConceptosBasicos extends AppCompatActivity {
    ...
    DataConceptosBasicos conceptosBasicos = new DataConceptosBasicos();

    DataConceptosBasicos dataConBasic = new DataConceptosBasicos();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.gridViewSelect.setAdapter(new OptAdapter(
                this,conceptosBasicos.textOpt(),conceptosBasicos.numberOpt()));
    ...
    private void openPdfClickItem(int i) {
        startActivity(PdfViewerActivity.Companion.launchPdfFromPath(
                ...
                dataConBasic.namePdf().get(i),
                dataConBasic.textOpt().get(i),
                "assets",
                false,
                true
        ));
