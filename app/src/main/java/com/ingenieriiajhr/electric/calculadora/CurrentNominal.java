...
public class CurrentNominal extends Fragment {



    public CurrentNominal() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_current_nominal, container, false);
